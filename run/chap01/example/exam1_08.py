...
def exam1_08(self):
	...
	try:
		...
		print( f"CALC circuit diode ideal-ID = {ID_ideal}A within {assert_percentage}% of accepted answer: {ans_ID}A" )
	...
	try:
		...
		print( f"CALC circuit ID = {ID_ideal}A within {assert_percentage}% of accepted answer: {ans_ID}A" )
	except AssertionError as e:
		print( f"CALC AssertionError {pnum}: {e}" )
