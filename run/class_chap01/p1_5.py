...
def p1_5(self):
	...
	print( f"GaAs ni @ 300K: {ni:.4e}/cm^3" )

	no:float = ni**2 / Na
	print( f"GaAs Na = 1e+16, no = {no:.4e}/cm^3" )

	try:
		assertions.assert_within_percentage( no, ans_a_no, 11.3 )
		print( f"GaAs no = {no:.3e}A" )
	...
	print( f"Ge ni @ 300K: {ni:.4e}/cm^3" )

	no = ni**2 / Na
	print( f"Ge Na = 1e+16, no = {no:.4e}/cm^3" )
